...
set FILES=skills.ndjson profile.ndjson projects.ndjson blog.ndjson services.ndjson testimonials.ndjson navigation.ndjson siteSettings.ndjson contact.ndjson

set COUNT=0
for %%F in (%FILES%) do (
    set /a COUNT+=1
    if exist "%%F" (
        echo [!COUNT!/9] Importing %%F...
