          ...
          <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-8 @lg:gap-12 items-center">
            ...
            <div className="@container/hero space-y-4 @md/hero:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Link
                  href="#projects"
                  className="inline-flex items-center justify-center px-8 py-3 text-base font-semibold rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-all shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-0.5"
                >
                  View Products
                </Link>
                {profile.socialLinks && (
                  <div className="flex flex-wrap gap-3 items-center">
                    {profile.socialLinks.github && (
                      <Link
                        ...
                        className="p-3 rounded-lg border hover:bg-accent hover:text-accent-foreground transition-colors"
                        aria-label="GitHub"
                      >
              ...
              <div className="flex flex-wrap gap-4 @md/hero:gap-6 pt-4 text-xs @md/hero:text-sm text-muted-foreground">
                ...
                {/* Availability removed as it was not in the new data, or can be optional */}
              </div>
            </div>
