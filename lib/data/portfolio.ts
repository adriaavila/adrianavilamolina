    ...
    projects: [
        {
            _id: "proj-7",
            title: "Mística",
            slug: { current: "mistica-app" },
            tagline: "Swim school management platform with real-time operations",
            description: "Swim school management platform with real-time operations",
            kind: "app",
            year: "2026",
            liveUrl: "https://mistica-app-fawn.vercel.app/",
            featured: true,
            image: "/images/projects/mistica-app.png",
            technologies: ["Next.js", "Convex", "TypeScript", "WhatsApp API"]
        },
        {
            _id: "proj-1",
